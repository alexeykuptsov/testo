...
namespace Testo.FileSystem.Impl
{
    public class DefaultSystemIODirectory : ISystemIODirectory
    {
        ...
        public System.IO.DirectoryInfo CreateDirectory(string subpath, System.Security.AccessControl.DirectorySecurity directorySecurity)
        {
            return Directory.CreateDirectory(Path.Combine(RootDir, subpath), directorySecurity);
        }
        ...
        public System.Security.AccessControl.DirectorySecurity GetAccessControl(string subpath)
        {
            return Directory.GetAccessControl(Path.Combine(RootDir, subpath));
        }
        public System.Security.AccessControl.DirectorySecurity GetAccessControl(string subpath, System.Security.AccessControl.AccessControlSections includeSections)
        {
            return Directory.GetAccessControl(Path.Combine(RootDir, subpath), includeSections);
        }
        public void SetAccessControl(string subpath, System.Security.AccessControl.DirectorySecurity directorySecurity)
        {
            Directory.SetAccessControl(Path.Combine(RootDir, subpath), directorySecurity);
        }
        ...
        public System.String[] GetFileSystemEntries(string subpath, string searchPattern, System.IO.SearchOption searchOption)
        {
        ...
        public IEnumerable<string> EnumerateDirectories(string subpath, string searchPattern, System.IO.SearchOption searchOption)
        {
        ...
        public IEnumerable<string> EnumerateFileSystemEntries(string subpath, string searchPattern, System.IO.SearchOption searchOption)
        {
