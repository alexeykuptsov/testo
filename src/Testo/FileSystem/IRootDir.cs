...
namespace Testo.FileSystem
{
    public interface IRootDir
    {
        ...
        System.IO.FileStream Create(string subpath, int bufferSize, System.IO.FileOptions options, System.Security.AccessControl.FileSecurity fileSecurity);
        void Delete(string subpath);
        void Decrypt(string subpath);
        void Encrypt(string subpath);
        ...
        System.IO.FileStream Open(string subpath, System.IO.FileMode mode, System.IO.FileAccess access, System.IO.FileShare share);
        ...
        System.Security.AccessControl.FileSecurity GetAccessControl(string subpath);
        System.Security.AccessControl.FileSecurity GetAccessControl(string subpath, System.Security.AccessControl.AccessControlSections includeSections);
        void SetAccessControl(string subpath, System.Security.AccessControl.FileSecurity fileSecurity);
